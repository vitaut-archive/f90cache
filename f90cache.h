 ...
 * GNU_GFC    : GCC 4 gfortran		version = 4.3 to 4.9
 * FSF_G95    : FSF g95			version = 0.91 to 0.94
 * INTEL_IFC  : INTEL ifort;		version = 9 to 13
 * OPEN64_F95 : OPEN64 openf95;		version = 4.2 to 4.5
 * SUN_F95    : ORACLE Studio f95;	version = 8.5 or 8.6
 */
#define GNU_GFC    1
#define FSF_G95    2
#define INTEL_IFC  3
...
void hash_module_file( const char *fname, int f90_compiler_type, int gnu_minor_version );
